export default {
  ...
  'activityBar.border': 'var(border)', //Activity Bar border color with the Side Bar.
  ...
  'activityBar.activeBorder': 'var(light_sea_green)',
  ...
  'sideBar.border': 'var(border)', //Side Bar border color on the side separating the editor.
  ...
  'sideBarSectionHeader.border': 'var(border)', //Side bar section header border color.
  ...
  'panel.border': 'var(border)', //Panel border color to separate the panel from the editor.
  ...
  'panelTitle.activeBorder': 'var(light_sea_green)', //Border color for the active panel title.
  ...
  'statusBar.border': 'var(border)', //Status Bar border color separating the Status Bar and editor.
  ...
  'terminal.border': 'var(border)', //The color of the border that separates split panes within the terminal. This defaults to panel.border.
